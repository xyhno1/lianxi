  ...
  <el-tabs v-model="userManage" type="card">
    ...
    <el-tab-pane label='权限管理' name='authority'>
      ...
      <el-table-column prop='ability_add'  label="通过申请"  align="center">
        <template slot-scope="{$index}">
        <el-checkbox v-model="authorityTable[$index].ability_add" @change="changeAdd($index)">
      ...
      <el-table-column prop='ability_delete'  label="修改权限"  align="center">
        <template slot-scope="{$index}">
        <el-checkbox v-model="authorityTable[$index].ability_delete" @change="changeDelete($index)"></el-checkbox>
        </template>
      </el-table-column>

      <el-table-column prop='ability_event_application'  label="申请活动"  align="center">
        <template slot-scope="{$index}">
        <el-checkbox v-model="authorityTable[$index].ability_event_application" @change="changeEvent($index)"></el-checkbox>
        </template>
      </el-table-column>
